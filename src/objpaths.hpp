...
const char* ae_inner_nm              = "obj/african_head/african_head_eye_inner_nm.tga";
...
const char* diablo3pose_nrmTangent   = "obj/diablo3_pose/diablo3_pose_nm_tangent.tga";
...
const char* grid_texture             = "obj/grid.tga";
